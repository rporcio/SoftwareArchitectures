...
public class ProducerComplexFixtureEditorPage extends FormPage {
	...
	private final ProducerComplexFixtureEditor editor;
	...
	public ProducerComplexFixtureEditorPage(ProducerComplexFixtureEditor editor, String id, String title, ComplexFixture fixture, List<EditableTableItem> tableitems) {
		...
		VALUE_SET = new String[materialsModel.getFixtures().size()];
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		nameText = toolkit.createText(parent, complexFixture.getName());
	    ...
	    for (FixtureWithNumber fixtureWithNumber : complexFixture.getFixtures()) {
	    	int i = 0;
