...
package hu.bme.aut.procurementofmaterials.splashHandlers;
...
public class InteractiveSplashHandler extends AbstractSplashHandler {
	...
	private void createProgressInfo() {
		  ...
		  progressBar = new ProgressBar(fCompositeLogin, SWT.SMOOTH);
	...
	private void handleButtonOKWidgetSelected() {
		...
		// any password
		if (UserAuthenticator.getInstance().authenticate(username, password)) {
